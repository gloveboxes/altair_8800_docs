...
1. To start the web terminal, from your web browser, navigate to `http://localhost` if you deployed the Altair emulator on your local machine, or `http://NAME_OR_IP_OF_COMPUTER_RUNNING_THE_ALTAIR_EMULATOR`.
